...
#define NUMBER_OF_MOST_SIGNIFICANT_BITS_USED_FOR_BUCKET_SORTING (static_cast<char>(sizeof(uint) * BITS_IN_A_BYTE) - EDGE_BITS + NUMBER_OF_BITS_FOR_BUCKETS)

// Number of least significant bits ignored during bucket sorting
#define NUMBER_OF_LEAST_SIGNIFICANT_BITS_IGNORED_DURING_BUCKET_SORTING (static_cast<char>(sizeof(uint) * BITS_IN_A_BYTE) - NUMBER_OF_MOST_SIGNIFICANT_BITS_USED_FOR_BUCKET_SORTING)
