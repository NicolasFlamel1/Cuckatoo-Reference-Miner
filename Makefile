...
# Otherwise check if compiling for Windows
	...
	# Package command
	PACKAGE_COMMAND = && "$(shell echo $(STRIP))" "./$(PROGRAM_NAME)"
...
# Otherwise check if compiling for iOS
	...
	# Package command
	PACKAGE_COMMAND = && "$(shell echo $(STRIP))" "./$(PROGRAM_NAME)" && rm -rf "./Payload" && mkdir -p "./Payload/$(NAME).app" && mv "./$(PROGRAM_NAME)" "./Payload/$(NAME).app" && echo "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.com/DTDs/PropertyList-1.0.dtd\">\n<plist version=\"1.0\">\n<dict>\n<key>CFBundleExecutable</key>\n<string>$(NAME)</string>\n<key>CFBundleName</key>\n<string>$(NAME)</string>\n<key>CFBundleIdentifier</key>\n<string>$(shell cat $(PROVISIONING_PROFILE) | grep -a "<key>application-identifier</key>" -A1 | grep -o "<string>.*</string>" | cut -d"." -f2-)\n<key>CFBundleVersion</key>\n<string>$(VERSION)</string>\n<key>CFBundleShortVersionString</key>\n<string>$(VERSION)</string>\n<key>MinimumOSVersion</key>\n<string>14.0</string>\n<key>UILaunchScreen</key>\n<dict/>\n</dict>\n</plist>" > "./Payload/$(NAME).app/Info.plist" && echo "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.com/DTDs/PropertyList-1.0.dtd\">\n<plist version=\"1.0\">\n<dict>\n<key>application-identifier</key>\n$(shell cat $(PROVISIONING_PROFILE) | grep -a "<key>application-identifier</key>" -A1 | grep -o "<string>.*</string>")\n</dict>\n</plist>" > "./Payload/entitlements.plist" && cp "$(shell echo $(PROVISIONING_PROFILE))" "./Payload/$(NAME).app/embedded.mobileprovision" && codesign -s "$(SIGNING_IDENTITY)" --entitlements "./Payload/entitlements.plist" "./Payload/$(NAME).app" && rm "./Payload/entitlements.plist" && zip -rq9 "./$(NAME).ipa" "./Payload" && rm -r "./Payload"
...
# Otherwise check if compiling for iOS simulator
	...
	# Package command
	PACKAGE_COMMAND = && "$(shell echo $(STRIP))" "./$(PROGRAM_NAME)" && rm -rf "./$(NAME).app" && mkdir "./$(NAME).app" && mv "./$(PROGRAM_NAME)" "./$(NAME).app" && echo "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<!DOCTYPE plist PUBLIC \"-//Apple//DTD PLIST 1.0//EN\" \"http://www.apple.com/DTDs/PropertyList-1.0.dtd\">\n<plist version=\"1.0\">\n<dict>\n<key>CFBundleExecutable</key>\n<string>$(NAME)</string>\n<key>CFBundleName</key>\n<string>$(NAME)</string>\n<key>CFBundleIdentifier</key>\n<string>com.$(subst $\ ,-,$(NAME))</string>\n<key>CFBundleVersion</key>\n<string>$(VERSION)</string>\n<key>CFBundleShortVersionString</key>\n<string>$(VERSION)</string>\n<key>MinimumOSVersion</key>\n<string>14.0</string>\n<key>UILaunchScreen</key>\n<dict/>\n</dict>\n</plist>" > "./$(NAME).app/Info.plist"
...
# Make clean
clean:
	$(DELETE_COMMAND) "./$(NAME)" "./$(NAME).exe" "./$(NAME).ipa" "./$(NAME).app" "./lib$(subst $\ ,_,$(NAME)).so" "./$(NAME).apk" "./$(NAME).apk.idsig" "./v2025.07.22.tar.gz" "./OpenCL-Headers-2025.07.22" "./OpenCL-ICD-Loader-2025.07.22" "./metal-cpp_26.4.zip" "./metal-cpp" "./Payload" "./build" > $(NULL_LOCATION) 2>&1
...
appleDependencies:
	...
	# Metal-cpp
	rm -rf "./metal-cpp_26.4.zip" "./metal-cpp" "./metal.h"
	curl -LO "https://developer.apple.com/metal/cpp/files/metal-cpp_26.4.zip"
	unzip "./metal-cpp_26.4.zip"
	rm "./metal-cpp_26.4.zip"
